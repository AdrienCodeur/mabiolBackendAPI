...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\TypeFinance>
 */
class TypeFinanceFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        return [
             ...
             'autrePaiment'=>$this->faker->streetName ,
             'datepaiment'=>$this->faker->dateTime() ,
